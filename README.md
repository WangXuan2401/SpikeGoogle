...
This package is a PyTorch port of the original **Spiking** Neural Networks with **GoogLe**Net-Like Inception Module(**SpikeGoogle**) framework for improved backpropagation based spiking neural networks (SNNs) learning with Inception modules. The original implementation is in C++ with CUDA and CUDNN.
...
* This work builds on initial implementation by [WangXuan](mailto:2301258861@qq.com)230125861@qq.com.

  

## Contact

For queries contact [Wang Xuan](mailto:2301258861@qq.com)
